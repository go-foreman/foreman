...
func NewSqlSagaStore(db *sql.DB, registry scheme.KnownTypesRegistry) (Store, error) {
	...
	return &sqlStore{db: db, typesRegistry: registry}, nil
}
...
func (s sqlStore) eventFromModel(ev historyEventModel) (*HistoryEvent, error) {
	res := &HistoryEvent{}
...
func (s sqlStore) instanceFromModel(sagaData sagaModel) (*sagaInstance, error) {
