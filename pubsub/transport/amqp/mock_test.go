...
// Source: github.com/go-foreman/foreman/pubsub/transport/amqp (interfaces: AmqpChannel,AmqpConnection,UnderlyingConnection,Delivery)
...
func (m *MockDelivery) Headers() amqp091_go.Table {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Headers")
	ret0, _ := ret[0].(amqp091_go.Table)
	return ret0
}
...
func (m *MockDelivery) Timestamp() time.Time {
	m.ctrl.T.Helper()
...
func (mr *MockDeliveryMockRecorder) Timestamp() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Timestamp", reflect.TypeOf((*MockDelivery)(nil).Timestamp))
}
